...
import (
	...
	"github.com/infobloxopen/atlas-db/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*AtlasdbV1alpha1Client, error) {
	...
	return &AtlasdbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AtlasdbV1alpha1Client for the given config and
...
func New(c rest.Interface) *AtlasdbV1alpha1Client {
	return &AtlasdbV1alpha1Client{c}
}
