	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AtlasdbV1alpha1().DatabaseServers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AtlasdbV1alpha1().DatabaseServers(namespace).Watch(options)
			},
		},
		&db_v1alpha1.DatabaseServer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseServerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&db_v1alpha1.DatabaseServer{}, f.defaultInformer)
}
