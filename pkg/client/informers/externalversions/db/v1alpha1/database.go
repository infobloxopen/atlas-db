	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AtlasdbV1alpha1().Databases(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AtlasdbV1alpha1().Databases(namespace).Watch(options)
			},
		},
		&db_v1alpha1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&db_v1alpha1.Database{}, f.defaultInformer)
}
