...
// DatabaseServers returns a DatabaseServerInformer.
func (v *version) DatabaseServers() DatabaseServerInformer {
	return &databaseServerInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
